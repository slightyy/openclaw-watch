...
本项目是一套**多设备 OpenClaw 运行状态集中监控系统**，服务端部署在服务器（VPS）的 Docker 中，通过 Docker Compose 一键运行。被监控设备分布在全球各地外网环境，不在同一内网，通过轻量 Agent 定时向服务端上报数据。管理员通过浏览器访问 Web 面板，统一查看所有设备状态、资源、Token、日志。

## 二、部署环境要求

### 服务端运行环境
- 服务器/VPS（Linux x86_64）
...
2. **防火墙**：确保安全组/防火墙开放 38888 和 38889 端口
